...
def predict():
    try:
        ...
        red_data = nn_model_predict(df,'models/best_keras_model_27_03_2024.keras')
        bayes_data = bayes_nn_model_predict(df,'models/best_bayes_model_weights_27_03_2024.h5',10)
